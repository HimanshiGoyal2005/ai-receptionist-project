    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        body { background: #F8FAFC; overflow-x: hidden; font-family: 'Space Grotesk', sans-serif; }
        ...
        @media(max-width:960px){ .login-left{display:none!important;} .login-right-panel{width:100%!important;} }
      `}</style>
